...
Packet::Packet(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
...
void Packet::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->transmission_time);
}
...
void Packet::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->transmission_time);
}

double Packet::getGeneration_time() const
{
    return this->generation_time;
}

void Packet::setGeneration_time(double generation_time)
{
    this->generation_time = generation_time;
}

double Packet::getTransmission_time() const
{
    return this->transmission_time;
}

void Packet::setTransmission_time(double transmission_time)
{
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='g' && strcmp(fieldName, "generation_time")==0) return base+0;
    if (fieldName[0]=='t' && strcmp(fieldName, "transmission_time")==0) return base+1;
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Packet *pp = (Packet *)object; (void)pp;
    switch (field) {
        case 0: return double2string(pp->getGeneration_time());
        case 1: return double2string(pp->getTransmission_time());
        default: return "";
    }
}
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Packet *pp = (Packet *)object; (void)pp;
    switch (field) {
        case 0: pp->setGeneration_time(string2double(value)); return true;
        case 1: pp->setTransmission_time(string2double(value)); return true;
